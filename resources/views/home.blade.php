                    ...
                    <div class="col-md-6">
                        <div class="card full-height">
                            <div class="card-body">
                                ...
                                <div class="card-category">Accumulative about your wallet activity</div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row py-3">
                                    <div class="col-md-4 d-flex flex-column justify-content-around">
                                        <div>
                                            <h6 class="fw-bold text-uppercase text-success op-8">Your Balance</h6>
                                            <h3 class="fw-bold">$9.782</h3>
                                        </div>
                                        <div>
                                            <h6 class="fw-bold text-uppercase text-info op-8"> Transaction</h6>
        ...
        <footer class="footer">
            <div class="container-fluid">
                ...
                <div class="copyright ml-auto">
                    2018, this theme by <a href="https://www.themekita.com">ThemeKita</a>
                </div>
            </div>
        </footer>
    </div>
