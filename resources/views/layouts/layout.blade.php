...
<head>
	...
	<title>Crysa | Crypto Wallet</title>
						...
						<li class="nav-item dropdown hidden-caret">
							...
							<ul class="dropdown-menu dropdown-user animated fadeIn">
								<div class="dropdown-user-scroll scrollbar-outer">
									<li>
										<div class="user-box">
											<div class="avatar-lg"><img src="../assets/img/Developer.png" alt="image profile" class="avatar-img rounded"></div>
											<div class="u-text">
	...
	$('#basic-datatables').DataTable();
		...
		var myPieChart = new Chart(pieChart, {
			...
			data: {
				...
				labels: ['TopUp', 'Transfer', 'WidthDraw']
			},
			options : {
				responsive: true,
